...
pkg_update_arr = [
  ...
  { pkg_name: 'gnome_session', pkg_rename: nil, pkg_deprecated: nil, comments: 'No longer compatible with any architecture, requires systemd.' },
  { pkg_name: 'gnome_settings_daemon', pkg_rename: nil, pkg_deprecated: nil, comments: 'No longer compatible with any architecture, requires systemd.' },
  { pkg_name: 'gnome_shell', pkg_rename: nil, pkg_deprecated: nil, comments: 'No longer compatible with any architecture, requires systemd.' },
  { pkg_name: 'gnome_tweaks', pkg_rename: nil, pkg_deprecated: nil, comments: 'No longer compatible with any architecture, requires systemd in dep package gnome_settings_daemon.' },
  { pkg_name: 'ilmbase', pkg_rename: nil, pkg_deprecated: nil, comments: 'Included in openexr.' },
  { pkg_name: 'js91', pkg_rename: nil, pkg_deprecated: nil, comments: 'Replaced by newer versions of js.' },
  { pkg_name: 'libcurl', pkg_rename: 'curl', pkg_deprecated: nil, comments: nil },
  { pkg_name: 'libmfx', pkg_rename: nil, pkg_deprecated: nil, comments: 'No longer compatible with any architecture' },
  ...
  { pkg_name: 'qtchooser', pkg_rename: nil, pkg_deprecated: nil, comments: "Doesn't work for newer Qt versions." },
  ...
  { pkg_name: 'ruby_debug', pkg_rename: nil, pkg_deprecated: nil, comments: 'Integrated into ruby package.' },
